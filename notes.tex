...
\end{prop}
\begin{proof}
Let $X=G/P=\{gP:g\in G\}$. Then $H$ acts on $X$ by left multiplication (since $G$ does) (Example 2.2.2.3). Consider the orbits and stabilisers. Fix $xP\in X$ where $x\in G$, then
\[
\begin{aligned}
